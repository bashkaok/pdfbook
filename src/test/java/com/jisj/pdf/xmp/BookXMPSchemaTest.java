...
class BookXMPSchemaTest {
    ...
    void createXMPScheme() {
        ...
        book.setTitle(title, "ru");
        assertEquals(title, book.getTitle().getContent());
        assertEquals("ru", book.getTitle().getLang());
        ...
        assertEquals("Work #1", a.getTitle().getContent());
        assertEquals("en", a.getTitle().getLang());
    ...
    void worksTest() {
        ...
        b.setTitle("Works test", "en");
        b.addWork().setTitle("Work #1", "ru");
        b.addWork().setTitle("Work #2", "de");
